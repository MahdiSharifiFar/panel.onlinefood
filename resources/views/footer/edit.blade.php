...
@section('content')
    ...
    <form action="{{ route('footer.update', ['footer' => $footer->id]) }}" method="post" class="row gy-4">
        ...
        <div class="col-md-3">
            ...
            <input name="work_start_time" type="text" value="{{ $footer->work_start_time }}" class="form-control" />
            <div class="form-text text-danger">
        ...
        <div class="col-md-3">
            ...
            <input name="work_end_time" type="text" value="{{ $footer->work_end_time }}" class="form-control" />
            <div class="form-text text-danger">
                @error('work_end_time')
                    {{ $message }}
                @enderror
