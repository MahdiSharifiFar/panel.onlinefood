...
@section('content')
    ...
    <form action="{{ route('product.store') }}" enctype="multipart/form-data" method="post" class="row gy-4 mb-5">
        ...
        <div class="col-md-3">
            ...
            <input name="discount_price" type="text" value="{{ old('discount_price') }}" class="form-control" />
            <div class="form-text text-danger">
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="start_date_discount" value="{{ old('start_date_discount') }}" type="text" class="form-control" />
            <div class="form-text text-danger">
                @error('start_date_discount')
                {{ $message }}
                @enderror
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="end_date_discount" value="{{ old('end_date_discount') }}" type="text" class="form-control" />
            <div class="form-text text-danger">
                @error('end_date_discount')
                {{ $message }}
                @enderror
            </div>
        </div>
