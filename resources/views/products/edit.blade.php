    ...
    <form action="{{ route('product.update', ['product' => $product->id]) }}" enctype="multipart/form-data" method="POST" class="row gy-4 mb-5">
        ...
        <div class="col-md-12 mb-5">
            <div class="row justify-content-center">
                <div class="col-md-4" x-data="imageViewer('{{ asset('assets/images/' . $product->primary_image) }}')">
        ...
        <div class="col-md-3">
            ...
            <select name="status" class="form-select">
                <option {{ $product->active == 1 ? 'selected' : '' }} value="1">فعال</option>
                <option {{ $product->active == 0 ? 'selected' : '' }} value="0">غیر فعال</option>
            </select>
            <div class="form-text text-danger">
                @error('status')
                {{ $message }}
        ...
        <div class="col-md-3">
            ...
            <input name="sale_price" type="text" value="{{ $product->discount_price }}" class="form-control" />
            <div class="form-text text-danger">
                @error('sale_price')
                {{ $message }}
                @enderror
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="date_on_sale_from" value="{{ $start_date_discount ?? '' }}" type="text" class="form-control" />
            <div class="form-text text-danger">
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="date_on_sale_to" value="{{ $end_date_discount ?? '' }}" type="text" class="form-control" />
            <div class="form-text text-danger">
